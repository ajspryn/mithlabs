                        ...
                        @foreach ($bahan_bakus as $bahan_baku)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a class="btn-btn-primary" href="/@role/stok-bahan-baku/{{ Illuminate\Support\Facades\Crypt::encryptString($bahan_baku->sku) }}">
        ...
        <div class="offcanvas offcanvas-end" id="add-new-record">
            ...
            <div class="offcanvas-body flex-grow-1">
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#forminput" aria-controls="forminput" aria-selected="true">
                            <i class="tf-icons ti ti-clipboard-text ti-xs me-1"></i> Form
                        </button>
                    </li>
                    <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#formexel" aria-controls="formexel" aria-selected="false">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="forminput" role="tabpanel">
                        <form class="needs-validation pt-0 row g-2" novalidate id="form-add-new-record" action="/@role/bahan-baku" method="post">
                            @csrf
                            <div class="col-sm-12">
                                <label class="form-label" for="sku">SKU</label>
                                <input type="text" id="sku" class="form-control @error('sku') is-invalid @enderror" name="sku" placeholder="Masukan SKU Bahan Baku" required autofocus />
                                <div class="valid-feedback">Ok!</div>
                                <div class="invalid-feedback">Harus Diisi.</div>
                            </div>
                            <div class="col-sm-12">
                                <label class="form-label" for="nama">Nama Bahan Baku</label>
                                <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Masukan Nama Bahan Baku" required />
                                <div class="valid-feedback">Ok!</div>
                                <div class="invalid-feedback">Harus Diisi.</div>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <input type="number" id="harga" class="form-control @error('harga') is-invalid @enderror" name="harga" placeholder="Masukan Harga/Satuan" required />
                                <div class="valid-feedback">Ok!</div>
                                <div class="invalid-feedback">Harus Diisi.</div>
                            </div>
                            <div class="col-sm-12">
                    ...
                    <div class="tab-pane fade" id="formexel" role="tabpanel">
                        <form class="needs-validation pt-0 row g-2" novalidate id="form-upload-new-record" method="post" action="/@role/bahan-baku" enctype="multipart/form-data">
                            @csrf
                            <div class="col-sm-12">
