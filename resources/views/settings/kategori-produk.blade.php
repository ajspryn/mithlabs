                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button class="dropdown-item" type="button" class="btn btn-primary"
                                                ...
                                                data-bs-target="#edit{{ $kategori->id }}"><i class="ti ti-pencil me-1"></i>
                                                Edit</button>
                                            <form action="/@role/setting/kategori-produk/{{ $kategori->id }}" method="POST"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
                            ...
                            <div class="offcanvas offcanvas-end" id="edit{{ $kategori->id }}">
                                ...
                                <div class="offcanvas-body flex-grow-1">
                                    <form class="needs-validation-edit pt-0 row g-2" id="form-edit"
                                        action="/@role/setting/kategori-produk/{{ $kategori->id }}" method="post">
                                        @method('put')
                                        @csrf
                                        <div class="col-sm-12">
        ...
        <div class="offcanvas offcanvas-end" id="add-new-record">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form class="needs-validation pt-0 row g-2" novalidate id="form-add-new-record"
                    action="/@role/setting/kategori-produk" method="post">
                    @csrf
                    <div class="col-sm-12">
                        <label class="form-label" for="kode">Kode Kategori</label>
                        <input type="text" id="kode" class="form-control @error('kode') is-invalid @enderror"
                            name="kode" placeholder="Masukan Kode Kategori" required autofocus
                            value="{{ old('kode') }}" />
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror"
                            name="nama" placeholder="Masukan Nama Kategori" required value="{{ old('nama') }}" />
                        <p class="valid-feedback">Ok!</p>
                        <p class="invalid-feedback">Harus Diisi.</p>
                    </div>
                    <div class="col-sm-12">
