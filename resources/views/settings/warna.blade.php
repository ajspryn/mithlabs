    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <td style="text-align: center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <form action="/warehouse/setting/warna/{{ $warna->id }}" method="POST" class="d-inline">
                                                @method('delete')
                                                @csrf
        ...
        <div class="offcanvas offcanvas-end" id="add-new-record">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form class="needs-validation pt-0 row g-2" novalidate id="form-add-new-record" action="/warehouse/setting/warna" method="post">
                    @csrf
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="kode" class="form-control @error('kode') is-invalid @enderror" name="kode"
                            placeholder="Masukan Kode Warna" required autofocus />
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror" name="nama"
                            placeholder="Masukan Nama Warna" required autofocus />
                        <p class="valid-feedback">Ok!</p>
                        <p class="invalid-feedback">Harus Diisi.</p>
                    </div>
                    <div class="col-sm-12">
