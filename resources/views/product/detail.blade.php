                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <button type="button" class="btn btn-secondary" data-bs-toggle="offcanvas" data-bs-target="#edit-product"
                                        ...
                                        <form class="needs-validation pt-0 row g-2" novalidate id="form-edit-product" method="post"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" id="formInput" class="form-control @error('nama') is-invalid @enderror"
                                                    name="nama" value="{{ old('nama', $product->nama) }}" placeholder="Masukan Nama Produk" required
                                                    autofocus />
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" id="namasingkatproduk"
                                                    ...
                                                    value="{{ old('nama_singkat', $product->nama_singkat) }}" placeholder="Masukan Inisial Produk"
                                                    required />
                                                <div class="valid-feedback">Ok!</div>
                                                <div class="invalid-feedback">Harus Diisi.</div>
                                            </div>
                                                ...
                                                <select class="form-select @error('warna') is-invalid @enderror" name="warna" id="warna"
                                                    ...
                                                    @foreach ($warnas as $warna)
                                                        <option value="{{ $warna->nama }}"
                                                            {{ old('warna', $product->warna) == $warna->nama ? 'selected' : '' }}>{{ $warna->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <div class="valid-feedback">Ok!</div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" id="sku_config" class="form-control @error('sku_config') is-invalid @enderror"
                                                    name="sku_config" value="{{ old('sku_config', $product->sku_config) }}"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" id="active_at"
                                                    ...
                                                    value="{{ old('active_at', $product->active_at) }}" placeholder="Active At" required />
                                                <div class="valid-feedback">Ok!</div>
                                                <div class="invalid-feedback">Harus Diisi.</div>
                                            </div>
                                            <div class="col-sm-12">
                                                ...
                                                <input type="number" id="cogm" class="form-control @error('cogm') is-invalid @enderror"
                                                    name="cogm" value="{{ old('cogm', $product->cogm) }}" placeholder="Masukan COGM" required />
                                                <div class="valid-feedback">Ok!</div>
                                                <div class="invalid-feedback">Harus Diisi.</div>
                                            </div>
                                            <div class="col-sm-12">
                                                ...
                                                <input type="number" id="cogs" class="form-control @error('cogs') is-invalid @enderror"
                                                    name="cogs" value="{{ old('cogs', $product->cogs) }}" placeholder="Masukan COGS" required />
                                                <div class="valid-feedback">Ok!</div>
                                                <div class="invalid-feedback">Harus Diisi.</div>
                                            </div>
                                            <div class="col-sm-12">
                                                ...
                                                <input type="number" id="harga_marketplace"
                                                    class="form-control @error('harga_marketplace') is-invalid @enderror" name="harga_marketplace"
