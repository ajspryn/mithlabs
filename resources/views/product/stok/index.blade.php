                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="teamMemberList">
                                <a class="dropdown-item"
                                    href="/@role/transaksi-bahan-baku">Lihat Semua Transaksi</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start align-items-center">
                                                <div class="d-flex flex-column">
                                                    <p class="mb-0 fw-semibold">{{ $transaksi->product->nama }}</p>
                                                    <small class="text-muted">{{ $transaksi->product->sku }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-column">
                                                ...
                                                <small
                                                    class="text-muted
                                    text-nowrap">{{ $transaksi->created_at->format('d-m-Y') }}</small>
                            </div>
                            </td>
                                ...
                                <tbody>
                                    @foreach ($stoks as $stok)
                                        <tr>
                                            ...
                                            <td style="text-align: center">{{ $stok->product->sku }}</td>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <span class="fw-semibold d-block">{{ $stok->product->nama }}</span>
                                                        <small class="text-muted">{{ $stok->product->warna }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td style="text-align: center">{{ $stok->stok }}</td>
                                            <td style="text-align: center">@rupiah($stok->product->harga * $stok->stok)</td>
                                            <td style="text-align: center">
                                                <a class="btn-btn-primary"
                                                    href="/@role/stok-product/{{ Illuminate\Support\Facades\Crypt::encryptString($stok->product->sku) }}">
